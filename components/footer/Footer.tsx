        ...
        <div className={styles.container}>
            <div className={styles.row}>
                ...
                <div className={styles.footer_col}>
                    ...
                    <ul>
                        <p className="text-white">Hot line: 1900-6035 <br></br> (1000 đ/phút, 8-21h mỗi ngày)</p>
                        <li><Link href="#">FAQ</Link></li>
                        <li><Link href="#">Hướng dẫn đặt hàng</Link></li>
                        <li><Link href="#">Giao hàng và nhận hàng</Link></li>
                ...
                <div className={styles.footer_col}>
                    ...
                    <ul>
                        ...
                        <li><Link href="#">Smartwatch</Link></li>
                        <li><Link href="#">Đồng hồ</Link></li>
                        <li><Link href="#">Máy cũ giá rẻ</Link></li>
                        <li><Link href="#">PC</Link></li>
                        <li><Link href="#">Máy in</Link></li>
                        <li><Link href="#">Điện gia dụng</Link></li>
                    </ul>
                </div>
                <div className={styles.footer_col}>
