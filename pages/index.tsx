...
export default function Home() {
   return (
      <nav className='navbar navbar-expand-lg bg-warning navbar-light flex align-items-center flex-column  '>
            ...
            <div className='collapse navbar-collapse d-flex justify-content-center flex-grow-0'>
               ...
               <form className='d-flex mt-3 ms-3'>
                  <div className='input-group mb-3'>
                     ...
                     />
                     <button type='button' className='btn bg-white border-0' id='button-search'>
            ...
            <div className='collapse navbar-collapse d-flex justify-content-center flex-grow-0'>
               <ul className='navbar-nav mb-2 mb-lg-0'>
                  <li className='nav-item'>
                     ...
                     <button type='button' className='btn border-0 btn-outline-dark bg-transparent'>
                        <i className='bi bi-phone-fill' style={{ fontSize: 20 }}></i> Máy cũ giá rẻ
                     </button>
                     <button type='button' className='btn border-0 btn-outline-dark bg-transparent'>
